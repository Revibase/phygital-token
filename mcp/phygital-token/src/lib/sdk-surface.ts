export const SDK_SURFACE = {
  ...
  rustClient: {
    ...
    cpi: [
      ...
      "SetMintCpiBuilder",
      "SetLinkedWalletCpi",
      "SetLinkedWalletCpiBuilder",
      "RemoveLinkedWalletCpi",
      "RemoveLinkedWalletCpiBuilder",
    ],
    types: ["PhygitalToken", "Secp256r1VerifyArgs", "PhygitalTokenType"],
    tokenTypes: {
      Permanent: "discriminant 0 — linked wallet required at init; transfer/remove rejected",
      Bearer: "freely transferable by passkey possession",
      Controlled: "lock after claim; forfeit via remove_linked_wallet before next transfer",
    },
  },
} as const;
